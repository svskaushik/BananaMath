                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                            {entries?.map((entry, index) => {
                                const percentageScore = ((entry.correct_count / entry.total_count) * 100).toFixed(2);
                                return (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap border-b text-stone-900 border-gray-200">{percentageScore}%</td>
